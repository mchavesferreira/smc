...
#define DADOS_LCD    	PORTB  	//4 bits de dados do LCD na porta D 
...
#define conv_ascii	0	//48 se ident_num() deve retornar um número no formato ASCII (0 para formato normal)
