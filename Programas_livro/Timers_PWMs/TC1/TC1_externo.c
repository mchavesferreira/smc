...
int main()
{
	...
	TIMSK1 = (1<<OCIE1A)|(1<<TOIE1);	//habilita a interrupção do TC1 por igualdade de comparação
	TCCR1B = (1<<WGM12)|(1<<CS12) | (1<<CS11) |(1<<CS10);//clock externo  contagem na borda de subida - modo CTC
	OCR1A = 59;							/*valor para a contagem máxima do TC1 (conta 60 vezes) – VALOR DE COMPARAÇÃO. 
